...
<body>
                                    ...
                                    <div class="row">
                                        <div class="col-10">
                                            <input type="text" class="form-control"
                                                placeholder="Silahkan cari judul buku" name="cari">
                                        </div>
                                        <div class="col-2">
    ...
    $data1 = mysqli_query($koneksi, "SELECT buku. *, kategori.nama_kategori, rak.nama_rak FROM buku INNER JOIN kategori ON buku.id_kategori = kategori.id
    INNER JOIN rak ON buku.id_rak = rak.id");
     
     $query = mysqli_query($koneksi, "SELECT buku.*, avg(ulasan_buku.rating) as rating, 
     kategori.nama_kategori, rak.nama_rak FROM buku
     LEFT JOIN ulasan_buku ON buku.id = ulasan_buku.id_buku
     INNER JOIN kategori ON buku.id_kategori = kategori.id
     INNER JOIN rak ON buku.id_rak = rak.id GROUP BY buku.id LIMIT $halaman_awal, $batas ");
     while ($data = mysqli_fetch_assoc($query)) :
        ?>

                                    <div class="col-md-4 col-12 mb-4 mt-4">
                                        <div class="card" style="width: 18rem;">
                                            <img src="../assets/images/<?php echo $data['gambar']; ?>" width="200px"
                                                height="300px" class="card-img-top" alt="...">
                                            <div class="card-body">
                                                <a href="#" class="btn btn-primary btn-sm float-end"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#modalKoleksi<?php echo $data['id']; ?>">+</a>
                                                <h5 class="card-title text-primary"><?php echo $data['judul']; ?></h5>
                                                <p class="card-text text-secondary">
                                                    <?php echo $data['nama_kategori']; ?></p>
                                            </div>

                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Penulis: <?php echo $data['penulis']; ?>
                                                </li>
                                                <li class="list-group-item">Penerbit: <?php echo $data['penerbit']; ?>
                                                </li>
                                                <li class="list-group-item">Tahun: <?php echo $data['tahun']; ?></li>
                                                <li class="list-group-item text-center"><?php echo $data['nama_rak']; ?>
                                                    |
                                                    Rating:
                                                    <?php echo round($data['rating'], 1) ?></li>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="modalKoleksi<?php echo $data['id']; ?>"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Koleksi</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="crud_koleksi.php" method="post">
                                                        ...
                                                        <div class="text-center">
                                                            <p>Apakah Anda yakin ingin menambah koleksi
...
?>
                        ...
                        <ul class="pagination justify-content">
                            ...
                            <li class="page-item">
                                <a class="page-link"
                                    <?php if($halaman < $halaman) {echo "href='?halaman=$next'";} ?>>next</a>
                            </li>
                        </ul>
