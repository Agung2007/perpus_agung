...
if(isset($_POST['btnSimpan'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO peminjaman (id_pengguna, id_petugas, id_buku, tgl_pinjam, status) 
...
if(isset($_POST['btnUbah'])) {
    ...
    tgl_pinjam = '$tanggal_pinjam', status = '$status_peminjaman' WHERE id = '$id_pinjam'");
