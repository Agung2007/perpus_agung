...
if (isset($_POST['btnUbah'])) {
    ...
    if ($ubah) {
        echo "<script>alert('Data kategori Berhasil Diubah'); document.location='kategori.php'</script>";
    } else {
        echo "<script>alert('Data kategori Gagal Diubah'); document.location='kategori.php'</script>";
    }
}
...
if (isset($_POST['btnHapus'])) {
    ...
    if ($hapus) {
        echo "<script>alert('Data kategori berhasil dihapus'); document.location='kategori.php'</script>";
    } else {
        echo "<script>alert('Data kategori gagal dihapus'); document.location='kategori.php'</script>";
    }
}
?>
